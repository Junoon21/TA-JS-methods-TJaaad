...
let finalArray=(addTwoToArray(numbers));
...
let finalArray=(addThreeToArray(numbers));
console.log(finalArray);
/*
...
let finalArray=(addFiveToArray(numbers));
console.log(finalArray);
/*
...
*/
function isAdult(studentDetails){
  return studentDetails.age > 18 ;
}
/*
...
*/
function isMale(studentDetails){
  return studentDetailsple.sex==`M`;
}
/*
...
*/
function isFemale(studentDetails){
  return studentDetails.sex==`F`;
}
/*
...
*/
function isGradeA(studentDetails){
  return studentDetails.grade > 12 ;
}
/*
...
*/
function isGradeB(studentDetails){
  return studentDetails.grade > 8 ;
}
/*
...
*/
function isGradeC(studentDetails){
  return studentDetails.grade <= 8 ;
}
/*
