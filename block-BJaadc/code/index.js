...
console.log(`The last character of ${message} is ${message.indexOf("you")}`);
// Log the index of word "still" in message
console.log(`The last character of ${message} is ${message.indexOf("still")}`);
// Log the index of word "answers" in message
console.log(`The last character of ${message} is ${message.indexOf("answers")}`);
...
for(let character of newMessage){
...
for(let character of messageArray){
    console.log(character);
}